...
void loop() {
  ...
  if (currentTime - lastSensorRead >= SENSOR_READ_INTERVAL) {
    ...
    float humidity = thermo.humidity;
    float ambientTemp = thermo.temperature;

    // Read surface temperature from built-in thermistor
    // Note: You can use this for the mirror temperature!
    float mirrorTemp = thermo.ntc_temperature;
